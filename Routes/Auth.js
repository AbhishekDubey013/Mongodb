...
router.get('/adh', async (req, res) => {
  try {
    const filteredQas = await AT.find({ flag: 'Y' }, { mobileNumber: 1, dataArray: 1 }); // This will fetch all documents from the "qas" collection where flag is 'Y' and only return the 'mobileNumber'
